...
#   sf::st_set_geometry(NULL) %>%
#   dplyr::select("GID_1", "year", "GDP", "ore_extraction", "POP_DEN", "GVA_IND_10_VA", "GVA_IND_10_VK", "large_port") %>%
...
X <- data %>%
  ...
  dplyr::select("GID_1", "year", "GDP", "ore_extraction", "POP_DEN", "GVA_IND_10_VA", "GVA_IND_10_VK", "large_port", "T") %>%
  dplyr::mutate(GVA_IND_10_VA = log(GVA_IND_10_VA)) %>%
